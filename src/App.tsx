...
function App() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "A real-time chat application allowing users to create and join rooms for secure one-on-one and group chats. Built with TurboRepo, Next.js, WebSocket, Prisma, JWT, Node.js, Express.js, and Tailwind CSS for seamless and secure communication.",
      tech: [
        "TurboRepo",
        "NextJS",
        "Websocket",
      ...
      github:
        "https://github.com/Anmol0987/chatApp-turborepo-nextJs-prisma-websocket",
      demo: "#",
    },
    {
      title: "Second Brain",
      description:
        "Developed Second Brain, a full-stack web application that enables users to sign in/up, embed and manage YouTube and Twitter content, and share personalized pages via unique links, using React.js, Tailwind CSS, Node.js, Express.js, JWT, MongoDB, and React Bits.",
      tech: [
        "React.Js",
        "Tailwind Css",
        "NodeJs",
    ...
    },
    {
      title: "Recipe App",
      description:
        "A dynamic recipe management application with real-time updates and state management.",
                      ...
                      <div className="grid lg:grid-cols-2 gap-8 sm:gap-12">
                        ...
                        >
                          ...
                          >
                            ...
                            in the MERN stack and React ecosystem. Currently
                            pursuing my B.Tech in CSE with a focus on Cyber
                            Security, I combine my academic knowledge with
                            practical experience in building modern web
                            applications.
                          </motion.p>
                        ...
                        >
                          <div className="flex items-start gap-3 sm:gap-4 mb-4 sm:mb-6">
                            ...
                            <div>
                              ...
                              >
                                Abstinent Research & Technologies • Sep 2024 -
                                Nov 2024
                              </p>
                            </div>
                          </div>
                          ...
                          >
                            {[
                              ...
                              >
                                <label
                                  htmlFor={field.id}
                                  className={`block text-sm font-mono tracking-wider mb-2 sm:mb-3 ${
                                    darkMode ? "text-cyan-400" : "text-blue-600"
                                  }`}
                                >
                                  {field.label}:
                        ...
                        >
                          ...
                          <div className="space-y-3 sm:space-y-4">
                            {[
                              {
                                icon: Mail,
                                label: "anmolmittal0987@gmail.com",
                                href: "mailto:anmolmittal0987@gmail.com",
                              },
                              {
                                icon: Mail,
                                label: "+91 7024511800",
                                href: "tel:+917024511800",
                              },
                            ].map((contact, index) => (
                              <motion.a
                                key={index}
                              ...
                              >
                                ...
                                <span className="font-mono text-sm tracking-wide break-all">
                                  {contact.label}
                                </span>
                              </motion.a>
                            ))}
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      <Heart
                        className={`w-4 h-4 sm:w-5 sm:h-5 ${
                          darkMode ? "text-cyan-400" : "text-red-500"
                        }`}
                      />
                    </motion.span>
